...
tasks.register("hello") {
    doLast {
        ...
        val fastAttacks: Set<javax.json.JsonObject> = o.map { it.asJsonObject().getJsonObject("quickMove") }.toSet()
        val chargedAttacks: Set<javax.json.JsonObject> = o.map { it.asJsonObject().getJsonObject("chargeMove") }.toSet()
...
fun parseJsonArray(s: String): javax.json.JsonArray {
    return javax.json.Json.createReader(s.reader()).use {
        it.readArray()
    }
}

fun toJsonArray(list: Collection<javax.json.JsonObject>): javax.json.JsonArray {
